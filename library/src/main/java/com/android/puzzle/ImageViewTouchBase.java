...
import com.android.puzzle.Cubic;
import com.android.puzzle.Easing;
import com.android.puzzle.FastBitmapDrawable;
import com.android.puzzle.IDisposable;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	/**
	 * Use this to change the {@link com.example.puzzleview.ImageViewTouchBase#setDisplayType(com.example.puzzleview.ImageViewTouchBase.DisplayType)} of
	 * this View
	 * @author alessandro
	 *
	 */
	 ...
	 * or the {@link com.example.puzzleview.ImageViewTouchBase.DisplayType} has been modified
	 * 
	 * @param left
	 * @param top
	 * @param right
