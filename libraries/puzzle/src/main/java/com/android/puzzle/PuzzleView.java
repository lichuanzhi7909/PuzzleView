...
public class PuzzleView extends ImageViewTouch {
	...
	public PuzzleView(Context context) {
		...
		mWidth = PxDpTransformer.getDisplayWidth(context);
		mHeight = PxDpTransformer.getDisplayHeight(context);
		setMinScale(0.9f);
...
//			if( mScale > 1.5 || mWidth > 480 || mHeight > 800)
//				localMatrix.postTranslate(getLeft() + mLeft, getTop() + mTop + 49 * mScale);
