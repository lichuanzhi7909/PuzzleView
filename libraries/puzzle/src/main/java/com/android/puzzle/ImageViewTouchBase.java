...
import com.rongcai.show.utils.Cubic;
import com.rongcai.show.utils.Easing;
import com.rongcai.show.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	/**
	 * Use this to change the {@link com.rongcai.show.view.ImageViewTouchBase#setDisplayType(com.rongcai.show.view.ImageViewTouchBase.DisplayType)} of
	 * this View
	 * @author alessandro
	 *
	 */
	 ...
	 * or the {@link com.rongcai.show.view.ImageViewTouchBase.DisplayType} has been modified
	 * 
	 * @param left
	 * @param top
	 * @param right
